...
async def handle_new_call(system: VoiceAgentSystem, chat_request: CallRequest):
    ...
    (system
        .with_speaking_node(conversation_node, conversation_bridge)  # Can speak to user
    ...
    await system.start()
    await system.send_initial_message("Welcome to the Interview Practice Platform! Please let me know what role you are applying for and when you are ready to begin the interview.")
