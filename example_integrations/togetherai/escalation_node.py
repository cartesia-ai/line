                    ...
                    try:
                        ...
                        if escalation_info.escalation_level == "HIGH":
                            ...
                            yield config.EscalationAlert(
                                escalation_info=f"ESCALATION NEEDED: {escalation_info.reason}",
                                urgency="high"
                            )
                            ...
                            yield config.EscalationAlert(
                                escalation_info=f"Escalation risk: {escalation_info.reason}",
                                urgency="medium"
                            )
                        ...
                        escalation_keywords = ["escalate", "frustrated", "angry", "unresolved", "human", "manager"]
