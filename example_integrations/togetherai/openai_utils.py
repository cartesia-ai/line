    ...
    "function": {
        ...
        "parameters": {
            ...
            "properties": {
                "query": {
                    "type": "string",
                    "description": "Search query to look up in knowledge base (e.g., 'login', 'billing', 'technical')"
                }
            },
            "required": ["query"],
        },
...
def search_knowledge_base(query: str) -> str:
    ...
    return "No relevant information found in knowledge base. Consider creating a support ticket for personalized assistance."
...
def create_support_ticket(title: str, description: str, priority: str) -> str:
    ...
    return f"Support ticket #{ticket_id} created successfully at {timestamp}. Priority: {priority.upper()}. You will receive updates via email."
...
def escalate_to_human_agent(reason: str, urgency: str) -> str:
    ...
    return f"Transferring you to a human agent. Reason: {reason}. Estimated wait time: {wait_time}. Please stay on the line."
